...
@SqlResultSetMapping(name = "getDataReportDataMapping", classes = {
		@ConstructorResult(targetClass = ReportGenEntity.class, columns = {
				@ColumnResult(name = "courseId", type = Long.class),
				@ColumnResult(name = "courseName", type = String.class),
				@ColumnResult(name = "genderM", type = Long.class),
				@ColumnResult(name = "genderF", type = Long.class),
				...
				@ColumnResult(name = "bangkok", type = Long.class),
				@ColumnResult(name = "center", type = Long.class),
				@ColumnResult(name = "sakonnakhon", type = Long.class),
				@ColumnResult(name = "northeast", type = Long.class),
				@ColumnResult(name = "north", type = Long.class),
				@ColumnResult(name = "east", type = Long.class),
				@ColumnResult(name = "west", type = Long.class),

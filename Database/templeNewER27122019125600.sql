...
) ENGINE=InnoDB AUTO_INCREMENT=24 DEFAULT CHARSET=utf8 COMMENT='ตารางสถานที่';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=1000 DEFAULT CHARSET=utf8 COMMENT='ตารางสมาชิก';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `members` VALUES (0,1,'admin','$2a$10$mucs8KKrKKW5Rtfs9vxUkeAHjFLG1x5RoIxTP79KjC2OPqT3U.edS',1,1,'-','-','-','000-000-0000','0000000000','admin@gmail.com',NULL,NULL,'2019-12-26 09:40:38','-','-','O','-','-','-','-','-',1,1,'0-0000-00000-00-0',22,NULL,NULL,'00000');
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='ตารางคำนำหน้า';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `title_names` VALUES (1,'นาย','นาย'),(2,'นาง','นาง'),(4,'พระอาจารย์','พระอาจารย์');
...
-- Dump completed on 2019-12-27 12:57:03

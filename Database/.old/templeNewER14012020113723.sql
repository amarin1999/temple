...
) ENGINE=InnoDB AUTO_INCREMENT=36 DEFAULT CHARSET=utf8 COMMENT='ตารางคอร์ส';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='ตารางสถานที่';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COMMENT='ตารางตู้เก็บสัมภาระ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `members` VALUES (0,1,'admin','$2a$10$mucs8KKrKKW5Rtfs9vxUkeAHjFLG1x5RoIxTP79KjC2OPqT3U.edS',1,1,'ผู้ดูแลระบบ','ผู้ดูแลระบบ','วัดป่าโสมพนัส','000-000-0000','0000000000','admin@gmail.com',NULL,NULL,'2020-01-09 07:01:03',NULL,NULL,'O',NULL,NULL,NULL,'- -','-',1,1,'0-0000-00000-00-0',22,NULL,NULL,'00000'),(1,3,'test','$2a$10$Wp6nvV5MUnzgBb5ckSAhNeEBvvAYacuF2d1IkuToBbpgTbi8dJLo.',1,1,'ทดสอบ','ทดสอบ','วัดป่าโสมพนัส','111-111-1111','111-111-1111',NULL,NULL,NULL,'2020-01-06 03:02:11',NULL,NULL,'O',NULL,NULL,NULL,'ยินดี สุขอ้น','-',1,1,'1-1111-11111-11-1',10,NULL,NULL,'11111'),(2,2,'monk','$2a$10$UGLhqsg/w4pLnyBUAH.2KuUXvndjJP1ImSHO74oAbBNliXGop0en.',4,3,'โสมพนัส','ธรรมะ','วัดป่าโสมพนัส','333-333-3333','333-333-3333',NULL,NULL,'2020-01-02 09:17:17','2020-01-02 09:17:17',NULL,NULL,'O',NULL,NULL,NULL,'- -','-',1,1,'2-2222-22222-22-2',42,12,'2007-02-14 17:00:00','33333'),(3,2,'monk2','$2a$10$UGLhqsg/w4pLnyBUAH.2KuUXvndjJP1ImSHO74oAbBNliXGop0en.',4,3,'ธรรมะ','โสมพนัส','วัดป่าโสมพนัส','444-444-4444','444-444-4444',NULL,NULL,'2020-01-14 11:34:00','2020-01-14 11:34:00',NULL,NULL,'0',NULL,NULL,NULL,'- -','-',1,1,'3-3333-33333-33-3',33,13,'2006-02-14 17:00:00','44444');
...
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COMMENT='ตารางการเดินทาง';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='ตารางเวลารับ ส่งการเดินทางของวัด';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-01-14 11:37:36

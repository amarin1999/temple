...
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COMMENT='ตารางสัมภาระ';
...
CREATE TABLE `courses` (
  ...
  `course_transportation_temple_id` int(11) DEFAULT NULL COMMENT 'fk ตารางการเดินทางของวัด',
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='ตารางคอร์ส';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=utf8 COMMENT='ตารางสถานที่';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `locations` VALUES (24,'วัดป่าโสมพนัส',1);
...
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8 COMMENT='ตารางตู้เก็บสัมภาระ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `members` VALUES (0,1,'admin','$2a$10$mucs8KKrKKW5Rtfs9vxUkeAHjFLG1x5RoIxTP79KjC2OPqT3U.edS',1,1,'ผู้ดูแลระบบ','ผู้ดูแลระบบ','วัดป่าโสมพนัส','000-000-0000','0000000000','admin@gmail.com',NULL,NULL,'2020-01-02 02:14:23',NULL,NULL,'O',NULL,NULL,NULL,'- -','-',1,1,'0-0000-00000-00-0',22,NULL,NULL,'00000'),(1,3,'test','$2a$10$Wp6nvV5MUnzgBb5ckSAhNeEBvvAYacuF2d1IkuToBbpgTbi8dJLo.',1,1,'ทดสอบ','ทดสอบ','วัดป่าโสมพนัส','111-111-1111','111-111-1111',NULL,NULL,'2020-01-02 09:15:27','2020-01-02 09:15:27',NULL,NULL,'O',NULL,NULL,NULL,'- -','-',1,1,'1-1111-11111-11-1',10,NULL,NULL,'11111'),(2,2,'monk','$2a$10$UGLhqsg/w4pLnyBUAH.2KuUXvndjJP1ImSHO74oAbBNliXGop0en.',4,3,'โสมพนัส','ธรรมะ','วัดป่าโสมพนัส','333-333-3333','333-333-3333',NULL,NULL,'2020-01-02 09:17:17','2020-01-02 09:17:17',NULL,NULL,'O',NULL,NULL,NULL,'- -','-',1,1,'2-2222-22222-22-2',42,12,'2007-02-14 17:00:00','33333');
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='ตารางของความคาดหวัง และประสบการณ์ที่ได้รับ ซึ่งมีการติดต่อกับตาราง Transportation';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='ตารางการเดินทางของวัด';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `transportations` (
  ...
  PRIMARY KEY (`tran_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='ตารางการเดินทางทั่วไป';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-01-02  9:25:51

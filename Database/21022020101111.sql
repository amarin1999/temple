...
) ENGINE=InnoDB AUTO_INCREMENT=89 DEFAULT CHARSET=utf8 COMMENT='ตารางคอร์ส';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8 COMMENT='ตารางสถานที่';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='ตารางสมาชิก';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `members` VALUES (0,1,'admin','$2a$10$mucs8KKrKKW5Rtfs9vxUkeAHjFLG1x5RoIxTP79KjC2OPqT3U.edS',1,1,'ผู้ดูแลระบบ','ผู้ดูแลระบบ','วัดป่าโสมพนัส','000-000-0000','000-000-0000','admin@gmail.com',NULL,'2020-01-14 11:34:00','2020-01-21 02:44:17',NULL,NULL,'O',NULL,NULL,NULL,'- -','-',1,1,'0-0000-00000-00-0',22,NULL,NULL,'00000'),(1,3,'test','$2a$10$Wp6nvV5MUnzgBb5ckSAhNeEBvvAYacuF2d1IkuToBbpgTbi8dJLo.',1,1,'ทดสอบ','ทดสอบ','วัดป่าโสมพนัส','111-111-1111','111-111-1111','TempleAPIv123456@gmail.com',NULL,NULL,'2020-02-17 02:47:58',NULL,NULL,'O',NULL,NULL,NULL,'- -','-',1,1,'1-1111-11111-11-1',10,NULL,NULL,'11111'),(2,2,'monk','$2a$10$UGLhqsg/w4pLnyBUAH.2KuUXvndjJP1ImSHO74oAbBNliXGop0en.',4,3,'โสมพนัส','ธรรมะ','วัดป่าโสมพนัส','111-111-1111','333-333-3333','TempleAPIv123456@gmail.com',NULL,NULL,'2020-02-12 21:29:45',NULL,NULL,'O',NULL,NULL,NULL,'- -','-',1,1,'2-2222-22222-22-2',42,12,'2007-02-13 06:00:00','33333'),(3,2,'monk2','$2a$10$UGLhqsg/w4pLnyBUAH.2KuUXvndjJP1ImSHO74oAbBNliXGop0en.',4,3,'ธรรมะ','โสมพนัส','วัดป่าโสมพนัส','444-444-4444','444-444-4444',NULL,NULL,'2020-01-14 11:34:00','2020-01-14 11:34:00',NULL,NULL,'O',NULL,NULL,NULL,'- -','-',1,1,'3-3333-33333-33-3',33,13,'2006-02-14 17:00:00','44444');
...
) ENGINE=InnoDB AUTO_INCREMENT=29 DEFAULT CHARSET=utf8 COMMENT='ตารางลงทะเบียนเรียน';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=80 DEFAULT CHARSET=utf8 COMMENT='ตารางของความคาดหวัง และประสบการณ์ที่ได้รับ ซึ่งมีการติดต่อกับตาราง Transportation';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=64 DEFAULT CHARSET=utf8 COMMENT='ตารางอนุมัติพิเศษ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=24 DEFAULT CHARSET=utf8 COMMENT='ตารางการเดินทาง';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COMMENT='ตารางเวลารับ ส่งการเดินทางของวัด';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-02-21 10:09:42
